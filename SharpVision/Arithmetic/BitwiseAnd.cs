...
{
    public static void BitwiseAnd(Matrix<byte> src1, Matrix<byte> src2, Matrix<byte> dst)
    {
    ...
    [SharpFunction("Arithmetic", "Performs bitwise and.")]
    private static object[] BitwiseAnd2(Matrix<byte> src1, Matrix<byte> src2)
    {
        Matrix<byte> dst = new();
